...
public class Example2 {
    public static void main(String[] args) {
        ...
        if(조건식1) {
            ...
            조건식2이 만족하지 않고, 조건식3이 만족할 경우 실행할 문장;
        }
        .......
        } else {
        ...
        ※ 기준식 또는 변수의 결과값의 case의 값과경우의수가 같아야하며, 경우의 수가 같지 않는 경우 반드시 default를 설정하여야 하며,
        case의 종료는 break로 해야하며, break가 저장되지 않으면, 아래 case의 연산까지 모두 진행하게 됨.
