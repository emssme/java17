...
public class ApiEx1 {
    public static void main(String[] args) {
        ...
        Math: 수학/삼각을 위한처리 클래스
        Wrapper: Character, Byte, Short, Integer, Long, Float, Double, Boolean 등으로 구성되어 있으며, Primitive Type은 멤버를 가질 수 없으므로, Reference Type인 해당 Wrapper를 활용하여 메서드를 활용할 수 있다.
        */
